    ...
    return [{
        ...
        },
        {
            ...
            controller: async (req, res, next) => {
                const test = await model.essay('5c6add34bf64a670b97042e8');
                ...
                async (req, res, next) => {
                    ...
                    if (!!req.body.lastName && !!req.body.firstName) {
                        try {
                            ...
                            var cookieOui = ["nom=" + lastName, "prenom=" + firstName, "gender=" + gender];
                            res.setHeader("Set-Cookie", cookieOui);
                            var isInDatabase = await model.checkUser(firstName, lastName);
                            if (isInDatabase) {
                                ...
                                model.createUser(firstName, lastName, gender);
                            }
                ...
                async (req, res, next) => {
                    if (!!req.body.lastName && !!req.body.firstName) {
                        try {
                            ...
                            const firstName = getUser.firstName;
                            const lastName = getUser.lastName;
                            var cookieOui = ["nom=" + lastName, "prenom=" + firstName];
                            res.setHeader("Set-Cookie", cookieOui);
