<template>
  <div class="recordBtn-container" id="recordBtn-container">
    <svg height="200" id="recordBtn" preserveAspectRatio="xMidYMid meet" viewBox="0 0 200 200" webgl="true"  :class="status">
      <g id="recordBtnGroup" @click="clicBtn()">
        <defs>
        ...
        <circle  cx="100" cy="100" r="70" id="recordBtn-bg" class="btn-background" />
        
        <g id="record-btn-numbers">
          <path class="number" id="nb1" d="M110.6,121.4h-9.1V96.6l0.1-4.1l0.1-4.5c-1.5,1.5-2.5,2.5-3.1,3l-4.9,4l-4.4-5.4l13.8-11h7.4V121.4z" transform-origin="center"/>
...
export default {
  ...
  mounted () {
    ...
    setTimeout(() => {
      const svgContainer = document.getElementById('recordBtn-container')
