this.recordIcon<template>
  <div class="recordBtn-container">
    <svg width="200" height="200" id="redordBtn" preserveAspectRatio="xMidYMid meet" viewBox="0 0 200 200" webgl="true" @click="clicBtn()">
       <defs>
      ...
      <circle  cx="100" cy="100" r="80" id="recordBtn-volume" transform-origin="100px 100px" fill="url(#volumeLevel)"/>
      <circle  cx="100" cy="100" r="70" id="recordBtn-bg"/>
      <g class="record-btn-icon">
       

        <path class="record-icon" d="M123.7,87.1c-1,0-1.8,0.8-1.8,1.8v11.4c0,12.1-9.8,21.9-21.9,21.9s-21.9-9.8-21.9-21.9V88.9 c0-1-0.8-1.8-1.8-1.8s-1.8,0.8-1.8,1.8v11.4c0,13.5,10.5,24.5,23.7,
        
        25.5v9.5h-9.5c-1,0-1.8,0.8-1.8,1.8c0,1,0.8,1.8,1.8,1.8h22.6 c1,0,1.8-0.8,1.8-1.8c0-1-0.8-1.8-1.8-1.8h-9.5v-9.5c13.2-0.9,23.7-12,23.7-25.5V88.9C125.6,87.9,124.8,87.1,123.7,87.1z"/>
...
export default {
  ...
  watch: {
    ...
    avgVolume: function (data) {
      const value = 1 + (data / 100)
      this.recordBtnVolume.setAttribute('transform', `scale(${value})`)
    }
  },
  mounted () {
    ...
    // Circle volume
    this.recordBtnVolume = document.getElementById('recordBtn-volume')
    ...
    bus.$on('stop_recording', () => {
      ...
      console.log('Stop recording sended')
    })
  },
  methods: {
    clicBtn () {
