this.recordIcon<template>
  <div class="recordBtn-container">
    <svg height="200" id="redordBtn" preserveAspectRatio="xMidYMid meet" viewBox="0 0 200 200" webgl="true" @click="clicBtn()" :class="status">
       <defs>
      ...
      <g class="text">
          <text x="100%"  y="50%" opacity="0" id="recordBtn-text" style="font-size: 32px; color: #00FF00">
...
.recordBtn-container,
  ...
  svg.notRecording:hover #recordBtn-bg{
    fill: #c61e42;
  }
  svg.notRecording:hover .record-icon{
    fill: #fff;
  }
  /*svg.notRecording:hover #recordBtn-volume{
    transform: scale(0.9)
  }*/
